...
int ggml_backend_sycl_reg_devices() {
    ...
    for (int i = 0; i < ggml_sycl_info().device_count; i++) {
        ...
        ggml_backend_register(name, ggml_backend_reg_sycl_init, ggml_backend_sycl_buffer_type(i), ggml_backend_sycl_host_buffer_type(), ggml_backend_sycl_get_device_memory, (void *) (intptr_t) i);
    }
    return ggml_sycl_info().device_count;
}
